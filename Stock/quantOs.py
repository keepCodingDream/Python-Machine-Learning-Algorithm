...
from Stock._config import myConfig
...
def save_data():
    ...
    ds.init_from_config(myConfig.data_config)
...
def do_backtest():
    ...
    backtest_props.update(myConfig.data_config)
    backtest_props.update(myConfig.trade_config)
...
def do_livetrade():
    ...
    props = {"period": "day",
             "strategy_no": 1044,
             "init_balance": 1e6}
    props.update(myConfig.data_config)
    props.update(myConfig.trade_config)
